...
type GetMessageListResponse struct {
	...
	Toatl *uint32        `protobuf:"varint,3,opt,name=toatl,proto3,oneof" json:"toatl,omitempty"`
}
...
func (x *GetMessageListResponse) GetToatl() uint32 {
	if x != nil && x.Toatl != nil {
		return *x.Toatl
	}
	return 0
}
...
var file_et_tcp_proto_rawDesc = []byte{
	...
	0x74, 0x12, 0x19, 0x0a, 0x05, 0x74, 0x6f, 0x61, 0x74, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d,
	0x48, 0x01, 0x52, 0x05, 0x74, 0x6f, 0x61, 0x74, 0x6c, 0x88, 0x01, 0x01, 0x42, 0x06, 0x0a, 0x04,
	0x5f, 0x72, 0x65, 0x74, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x74, 0x6f, 0x61, 0x74, 0x6c, 0x22, 0x8f,
